...
#define leftd 29
#define topd 275
@interface Test : UIViewController <UITableViewDelegate, UITableViewDataSource,PassValueDelegate,MBProgressHUDDelegate, ZBarReaderDelegate,UIAlertViewDelegate>{
	NSString *_value;
