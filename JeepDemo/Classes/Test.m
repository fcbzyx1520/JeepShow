...
- (void)viewDidLoad {
 ...
 tableView2.frame=CGRectMake(0, 46, 320,screenheight-44-70);
  // view3.frame=CGRectMake(0, 0, 320,screenheight-44);
	...
	[myscroll setContentSize:CGSizeMake(320, 1750)];
...
-(void)SetView1forPage
{
    ...
    rb1weekly.frame = CGRectMake(leftd,topd+21,102,28);
    rb2weekly.frame = CGRectMake(leftd+91,topd+21,102,28);
    rb1month.frame = CGRectMake(leftd+191,topd+21,102,28);
	rb3month.frame = CGRectMake(leftd,topd+35+21,102,28);
	rb6month.frame = CGRectMake(leftd+91,topd+35+21,102,28);
	rb1year.frame = CGRectMake(leftd+191,topd+35+21,102,28);
	rb2year.frame = CGRectMake(leftd,topd+70+21,102,28);
	rb1no.frame = CGRectMake(leftd+91,topd+70+21,102,28);
	rb1weekly.tag=0;
    rb2weekly.tag=1;
    rb1month.tag=2;
    rb3month.tag=3;
	...
	RadioButton *rb1 = [[RadioButton alloc] initWithGroupId:@"second group" index:0 settitle:@"2013大切诺基SRT8"]; 
	RadioButton *rb2 = [[RadioButton alloc] initWithGroupId:@"second group" index:1 settitle:@"2013大切诺基3.6L"]; 
	RadioButton *rb3 = [[RadioButton alloc] initWithGroupId:@"second group" index:2 settitle:@"2013大切诺基5.7L"]; 
	RadioButton *rb4 = [[RadioButton alloc] initWithGroupId:@"second group" index:3 settitle:@"2014大切诺基3.6L"]; 
     RadioButton *rb30 = [[RadioButton alloc] initWithGroupId:@"second group" index:4 settitle:@"2014大切诺基5.7L"];
    RadioButton *rb37 = [[RadioButton alloc] initWithGroupId:@"second group" index:5 settitle:@"2014大切诺基SRT8"];
	rb1.frame = CGRectMake(leftd,topd+196,244,28);
    rb2.frame = CGRectMake(leftd,topd+226,284,28);
    rb3.frame = CGRectMake(leftd,topd+256,244,28);
	rb4.frame = CGRectMake(leftd,topd+286,244,28);
	rb30.frame = CGRectMake(leftd,topd+316,244,28);
    
	rb37.frame = CGRectMake(leftd,topd+346,244,28);
	UILabel *questionText2 = [[UILabel alloc] initWithFrame:CGRectMake(leftd,topd+376,300,20)];
	...
	RadioButton *rb5 = [[RadioButton alloc] initWithGroupId:@"second group" index:6 settitle:@"2013指南者2.4L"]; 
	RadioButton *rb6 = [[RadioButton alloc] initWithGroupId:@"second group" index:7 settitle:@"2013指南者2.0L"]; 
	RadioButton *rb7 = [[RadioButton alloc] initWithGroupId:@"second group" index:8 settitle:@"2014 指南者2.4L"];
    RadioButton *rb31= [[RadioButton alloc] initWithGroupId:@"second group" index:9 settitle:@"2014 指南者2.0L"];
    RadioButton *rb32 = [[RadioButton alloc] initWithGroupId:@"second group" index:10 settitle:@"2014 指南者2.4L 蛇年特别版"];
	rb5.frame = CGRectMake(leftd,topd+406,244,28);
    rb6.frame = CGRectMake(leftd,topd+436,244,28);
    rb7.frame = CGRectMake(leftd,topd+466,244,28);
    rb31.frame = CGRectMake(leftd,topd+496,244,28);
    rb32.frame = CGRectMake(leftd,topd+526,244,28);
	...
	RadioButton *rb8 = [[RadioButton alloc] initWithGroupId:@"second group" index:11 settitle:@"2013牧马人Sahara 两门款"]; 
	RadioButton *rb9 = [[RadioButton alloc] initWithGroupId:@"second group" index:12 settitle:@"2013牧马人Sahara 四门款"]; 
	RadioButton *rb10 = [[RadioButton alloc] initWithGroupId:@"second group" index:13 settitle:@"2013牧马人Rubicon 两门款"]; 
	RadioButton *rb11 = [[RadioButton alloc] initWithGroupId:@"second group" index:14 settitle:@"2013牧马人Rubicon 四门款"]; 
	RadioButton *rb12 = [[RadioButton alloc] initWithGroupId:@"second group" index:15 settitle:@"2014 牧马人 Rubicon 十周年纪念款"]; 
   ...
   // rb13.frame = CGRectMake(leftd,topd+657,244,28);
	...
	RadioButton *rb14= [[RadioButton alloc] initWithGroupId:@"second group" index:16 settitle:@"2013 自由客"]; 
	RadioButton *rb15 = [[RadioButton alloc] initWithGroupId:@"second group" index:17 settitle:@"2014 自由客"]; 
	RadioButton *rb16 = [[RadioButton alloc] initWithGroupId:@"second group" index:18 settitle:@"2014 自由客 蛇年特别版"]; 
    ...
    RadioButton *rb17 = [[RadioButton alloc] initWithGroupId:@"second group" index:19 settitle:@"2014 自由光"]; 
    ...
    RadioButton *rb33 = [[RadioButton alloc] initWithGroupId:@"second group" index:20 settitle:@"300C"]; 
    rb33.frame = CGRectMake(leftd,topd+956,244,28);
    RadioButton *rb34= [[RadioButton alloc] initWithGroupId:@"second group" index:21 settitle:@"300S"]; 
    rb34.frame = CGRectMake(leftd,topd+986,244,28);
    RadioButton *rb35 = [[RadioButton alloc] initWithGroupId:@"second group" index:22 settitle:@"大捷龙"]; 
    ...
    RadioButton *rb36= [[RadioButton alloc] initWithGroupId:@"second group" index:23 settitle:@"酷威"]; 
    rb36.frame = CGRectMake(leftd,topd+1076,244,28); 		
    
    
	rbgroup2=[[NSArray alloc] initWithObjects:@"2013大切诺基SRT8",
			  @"2013大切诺基3.6L",@"2013大切诺基5.7L",@"2014大切诺基3.6L",@"2014大切诺基5.7L",@"2014大切诺基SRT8",
			  @"2013指南者2.4L",@"2013指南者2.0L",@"2014 指南者2.4L",@"2014 指南者2.0L",@"2014 指南者2.4L 蛇年特别版",
			  @"2013牧马人Sahara 两门款",@"2013牧马人Sahara 四门款",@"2013牧马人Rubicon 两门款",
			  @"2013牧马人Rubicon 四门款",@"2014 牧马人 Rubicon 十周年纪念款",
			  @"2013 自由客",@"2014 自由客",@"2014 自由客 蛇年特别版",@"2014 自由光",
   ...
   // rb13.tag=12;
	...
	[dicrbvalue setObject:rb1 forKey:@"2013大切诺基SRT8"];
	[dicrbvalue setObject:rb2 forKey:@"2013大切诺基3.6L"];
	[dicrbvalue setObject:rb3 forKey:@"2013大切诺基5.7L"];
	[dicrbvalue setObject:rb4 forKey:@"2014大切诺基3.6L"];
	[dicrbvalue setObject:rb5 forKey:@"2013指南者2.4L"];
	[dicrbvalue setObject:rb6 forKey:@"2013指南者2.0L"];
	[dicrbvalue setObject:rb7 forKey:@"2014 指南者2.4L"];
	[dicrbvalue setObject:rb8 forKey:@"2013牧马人Sahara 两门款"];
	[dicrbvalue setObject:rb9 forKey:@"2013牧马人Sahara 四门款"];
	[dicrbvalue setObject:rb10 forKey:@"2013牧马人Rubicon 两门款"];
	[dicrbvalue setObject:rb11 forKey:@"2013牧马人Rubicon 四门款"];
	[dicrbvalue setObject:rb12 forKey:@"2014 牧马人 Rubicon 十周年纪念款"];
	//[dicrbvalue setObject:rb13 forKey:@"2012牧马人梦十珍藏版"];
	[dicrbvalue setObject:rb14 forKey:@"2013 自由客"];
	[dicrbvalue setObject:rb15 forKey:@"2014 自由客"];
	[dicrbvalue setObject:rb16 forKey:@"2014 自由客 蛇年特别版"];
	[dicrbvalue setObject:rb17 forKey:@"2014 自由光"];
    	[dicrbvalue setObject:rb30 forKey:@"2014大切诺基SRT8"];
    [dicrbvalue setObject:rb37 forKey:@"2014大切诺基5.7L"];
    	[dicrbvalue setObject:rb31 forKey:@"2014 指南者2.0L"];
    	[dicrbvalue setObject:rb32 forKey:@"2014 指南者2.4L 蛇年特别版"];
	...
	//[submitBtn release];
     ...
     mybguiview.frame = CGRectMake(0, 0, 320,1500);
    //[submitBtn setTitle:@"上传" forState:UIControlStateNormal];
...
-(IBAction)cbxclickCompney
{
	...
	NSArray *array=[[NSArray alloc]initWithObjects:
					@"上海信佳:上海信佳汽车销售服务有限公司",@"上海名创:上海名创汽车销售服务有限公司",@"上海越也:上海越也汽车销售服务有限公司",@"中进名创:上海名创汽车销售服务有限公司 (虹桥店)",nil];
	//self.pickerData=self.zips;:
    selected=@"上海信佳:上海信佳汽车销售服务有限公司";
	CGContextRef context = UIGraphicsGetCurrentContext();
    [UIView beginAnimations:nil context:context];
    [UIView setAnimationCurve:UIViewAnimationCurveEaseInOut];
    [UIView setAnimationDuration:0.6];//动画时间长度，单位秒，浮点数
